...
public class ParseJSONArrayObj extends  AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parse_jsonobject);
        ...
        final ProgressDialog pDialog = new ProgressDialog(ParseJSONArrayObj.this);
